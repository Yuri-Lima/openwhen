...
class VaultFiltersState {
  ...
  VaultFiltersState clearTab(int index) {
    switch (index) {
      case 0:
        return copyWith(waiting: WaitingTabFilters.initial);
      case 1:
        return copyWith(opened: OpenedTabFilters.initial);
      case 2:
        return copyWith(sent: SentTabFilters.initial);
      case 3:
        return copyWith(capsules: CapsulesTabFilters.initial);
      default:
        return this;
    }
  }
