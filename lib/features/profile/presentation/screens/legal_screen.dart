        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              _buildContact(context, l10n.aboutContactSupport, 'suporte@openwhen.live'),
              _buildContact(context, l10n.aboutContactPrivacy, 'privacidade@openwhen.live'),
              _buildContact(context, l10n.aboutContactLegal, 'juridico@openwhen.live'),
              _buildContact(context, l10n.aboutContactDpo, 'dpo@openwhen.live'),
            ],
          ),
        ),
        const SizedBox(height: 24),
