...
Sem filtro lexical em cartas e cápsulas. A moderação é feita **exclusivamente pela IA (OpenAI Moderation API) no momento do envio**.
...
|---------|---------|--------|
| Sem filtro lexical em cartas/cápsulas | IA apenas | Evita falsos positivos |
