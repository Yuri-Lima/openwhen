...
- **Termos de Uso — cláusula de encerramento de serviço:** nova Seção 7 "Descontinuação do Serviço e Garantia de Entrega" — aviso 90 dias, exportação de dados, entrega de cartas pendentes, Fundo de Continuidade (reserva 2 anos). Em 3 idiomas.
...
- **Plano de contingência de encerramento:** [`planning/CONTINGENCY_PLAN.md`](CONTINGENCY_PLAN.md) com cronograma dia-a-dia (90 dias), tratamento de cartas pendentes (4 cenários), Fundo de Continuidade (meta, alimentação, transparência), aspectos legais LGPD/GDPR/CCPA, responsabilidades e checklist de testes.
...
- **Ícones e branding:** [`DESIGN_SYSTEM.md`](DESIGN_SYSTEM.md) — kit SVG (`assets/icons/`), `OpenWhenIcons` / `OpenWhenSvgIcon`, launcher (`assets/branding/app_icon.png`, `dart run flutter_launcher_icons`). [`README.md`](../README.md) / [`README.pt-BR.md`](../README.pt-BR.md) — tabela de stack e árvore do projeto com `assets/` e `shared/icons/`. [`ARCHITECTURE.md`](ARCHITECTURE.md) — entrada `shared/icons/`, parágrafo sobre assets na raiz. [`FLUTTER_COMMANDS.md`](../FLUTTER_COMMANDS.md) — comando para regenerar ícones do app.
...
- **Kit de ícones:** SVGs em [`assets/icons/`](../assets/icons/) (envelope, carta, cápsula, coração, cadeados, sino, brilhos, lacre, presente); [`lib/shared/icons/openwhen_icons.dart`](../lib/shared/icons/openwhen_icons.dart); dependência `flutter_svg`. Ícone do app: [`assets/branding/app_icon.png`](../assets/branding/app_icon.png) + **flutter_launcher_icons** (Android adaptativo fundo `#EDE5D8`, iOS AppIcon). Regenerar launchers: `dart run flutter_launcher_icons`.
